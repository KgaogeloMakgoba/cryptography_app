...
A C++ console application implementing encryption and decryption algorithms from scratch — no external cryptography libraries used. Built as a self-directed project to move from guided school practicals to independent software development.
